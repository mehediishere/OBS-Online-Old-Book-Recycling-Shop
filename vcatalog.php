<?php
    ...
    if(isset($_GET['search']))
    {
        ...
        if($src=="new")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%volunteer%' OR category LIKE '%free%'";
        }elseif($src=="academic")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%academic%' AND category LIKE '%volunteer%' ORDER BY srl DESC";
        }elseif($src=="jobPreparation")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%job%' AND category LIKE '%volunteer%' ORDER BY srl DESC";
        }elseif($src=="entertainment")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%volunteer%' AND category NOT LIKE '%academic%' AND category NOT LIKE '%job%' AND category NOT LIKE '%career%' AND category NOT LIKE '%business%' ORDER BY srl DESC";
        }elseif($src=="careerAndBusiness")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%volunteer%' AND category LIKE '%career%' OR category LIKE '%volunteer%' AND category LIKE '%business%' ORDER BY srl DESC";
        }elseif($src=="technology")
        {
            $viewSql = "SELECT * FROM tb_books WHERE category LIKE '%technology%' AND category LIKE '%volunteer%' ORDER BY srl DESC";
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-xl-3" style="margin-right: 10px;padding: 20px;border: 1px solid rgb(213,197,197);box-shadow: 5px 0px 10px -7px rgba(0,0,0,0.75)!important;">
                        <div>
                            ...
                            <hr>
                        </div><a class="category_link d-flex" href="vcatalog.php?search=academic"><i class="fa fa-book"></i>&nbsp;Academic</a><a class="category_link d-flex" href="vcatalog.php?search=jobPreparation"><i class="fa fa-book"></i>&nbsp;Job Preparation</a>
                        <a class="category_link d-flex" href="vcatalog.php?search=careerAndBusiness"><i class="fa fa-book"></i>&nbsp;Career &amp; Business</a><a class="category_link d-flex" href="vcatalog.php?search=technology"><i class="fa fa-book"></i>&nbsp;Technology</a>
                        <div>
                        ...
                        <a
                            class="category_link d-flex" href="vcatalog.php?search=entertainment"><i class="fa fa-book"></i>&nbsp;Drama</a><a class="category_link d-flex" href="#"><i class="fa fa-book"></i>&nbsp;Horror</a><a class="category_link d-flex" href="#"><i class="fa fa-book"></i>&nbsp;Crime</a><a class="category_link d-flex"
                                href="#"><i class="fa fa-book"></i>&nbsp;Cooking</a><a class="category_link d-flex" href="#"><i class="fa fa-book"></i>&nbsp;Children's</a><a class="category_link d-flex" href="#"><i class="fa fa-book"></i>&nbsp;Arts &amp; Graphics</a>
                            <a
                            ...
                            <div class="col-12 col-md-6 col-lg-4" style="margin-bottom: 10px;">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col"><button class="btn btn-warning btn-block btn-sm shadow-none" type="button" onclick="window.location.href='requestorbuy.php?book=<?php echo $row['bookid'] ?>';"><i class="fas fa-stream"></i>Details</button></div>
