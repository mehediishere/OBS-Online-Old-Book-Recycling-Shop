            ...
            <div class="container shadow" style="margin-top: 100px;background-color: #FFFFFF;padding: 20px;">
                <div style="margin-left: 15px;margin-right: 15px;">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 col-xl-4">
                            <div class="text-center"><img src="<?php echo $image; ?>"
                                    style="width: 100%;height: 400px;border: 1px solid rgb(231,231,231);padding: 30px;">
                            </div>
                        </div>
                        <div class="col"><span class="badge badge-secondary"><?php echo $row['bookstate'] ?></span>
                            <form action="" method="POST">
                                <h5><strong><?php echo $row['name'] ?></strong></h5>
                                <p style="font-size:14px;">By <strong
                                        style="color:rgb(68,89,108);"><?php echo $row['author'] ?></strong></p>
                                <p style="font-size:14px;">Publisher : <strong
                                        style="color:rgb(68,89,108);"><?php echo $row['publisher'] ?></strong></p>
                                <p style="font-size: 13px;">Category : <a href=""
                                        style="text-decoration: none; color: rgb(8, 140, 255);"><?php echo $row['category'] ?></a>
                                </p>
                                ...
                                <div><button class="btn btn-success btn-sm shadow-none" type="submit"><i
                                            class="fa fa-cart-arrow-down"></i>&nbsp;Add to Cart</button>
                                    <a href="#"
                                        style="margin-left: 20px;color: var(--danger);/*text-decoration: none;*/font-size: 14px;"><i
                                            class="fa fa-info-circle"></i>&nbsp;Report any issue</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div style="margin: 15px;">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation" id="t-1"><a class="nav-link active" role="tab"
                                data-toggle="tab" href="#tab-1">Summary</a></li>
                        <li class="nav-item" role="presentation" id="t-2"><a class="nav-link" role="tab"
                                data-toggle="tab" href="#tab-2">Author</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="tab-2">
                            ...
                            <table class="table table-bordered mt-3 mb-3">
                                <tbody style="font-size: 0.9rem;">
                                    <tr>
                                        <td style="background-color: #F1F2F4; width: 20%;">
                                            <?php echo $authorRow['name'] ?></td>
                                        <td><img src="<?php echo "author/".$authorRow['image'] ?>"
                                                style="width: 150px;height: 200px;border: 1px solid rgb(231,231,231);padding: 3px;">
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-bordered mt-3 mb-3">
                                <tbody style="font-size: 0.9rem;">
                                    <tr>
                                        <td style="background-color: #F1F2F4; width: 20%;"><?php echo $row['author'] ?>
                                        </td>
                                        <td><img src=""
                                                style="width: 150px;height: 200px;border: 1px solid rgb(231,231,231);padding: 3px;">
                                        </td>
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    this.page.url = "http://localhost/obs/bookdetails.php?book=<?php echo $row['bookid'] ?>";  // Replace PAGE_URL with your page's canonical URL variable
    this.page.identifier = "obs/bookdetails.php?book=<?php echo $row['bookid'] ?>"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
    };
...
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
        ...
        <section>
            <div class="container"
                style="margin-top: 10px;background-color: #FFFFFF;padding: 20px;margin-bottom: 10px;">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="col-12 mt-5">
                                ...
                                <div class="text-right">
                                    <a style="text-shadow: none;" class="btn btn-light btn-info"
                                        href="#carouselExampleControls" role="button" data-slide="prev">
                                        <i class="controls class-fade">
                                            << </i>
                                    </a>
                                    <a class="btn btn-light btn-info" href="#carouselExampleControls" role="button"
                                        data-slide="next">
